...
enum AkCallbackType
{
	...
	AK_MusicSyncPoint				= 0x4000,	///< Enable notifications on Music switch transition synchronization point.
...
/// the bank memory was managed internally, an error occurred, or in the case of.
